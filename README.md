...
[![Python](https://img.shields.io/badge/Python-3.11+-blue)](https://www.python.org/downloads/) [![License](https://img.shields.io/badge/License-AGPL--3.0-blue)](https://www.gnu.org/licenses/agpl-3.0.html) [![Tasks](https://img.shields.io/badge/Tasks-24-brightgreen)](frontend/MFAAvalonia/config/instances/default.json) [![Templates](https://img.shields.io/badge/Templates-786-orange)](resources/narutomobile/image) [![GUI](https://img.shields.io/badge/GUI-MFAAvalonia-purple)](https://github.com/MaaXYZ/MaaFramework)
...
> **naruto-auto-daily** = 通过模板匹配(OpenCV `TM_CCOEFF_NORMED`)+ MaaFramework pipeline 节点,把火影手游里 24 个"日常任务"(邮件/签到/活跃/招募/活动/战斗副本/叛忍/百忍/...)自动化执行,无需 GPU 只需 MuMu 12 模拟器(1920x1080)+ 永不停歇的小忍者。
...
**已知限制**:
- `point_race` (积分赛) / `secret_realm` (秘境): 忍者指引导航已修复, 但业务层模板匹配仍在排查; 如果这两个任务无法正常完成, 请在 GUI 运行后检查日志是否出现 `recognition failed`
...
│   - pipeline/merged.json (24 task 入口)                    │
│   - image/ (786 PNG 模板)                                 │
